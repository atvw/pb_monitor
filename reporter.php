...
//	*** define("PATH_DB", '{local path to}'.'/db.php}');
	define("PATH_DB", 'd:/sites/htdocs/pberghei_beheer/_monitor/scandb.php');
} else {
	define("PATH_DB", "/home/studitg1/domains/pberghei.eu/beheer/_monitor/scandb.php");
}
//	END OF CONFIGURE
...
$results = mysqli_query($scandb,"SELECT stamp, status, file_path, file_last_mod FROM monitor_history WHERE acct = '$acct' AND stamp > '$yesterday'");
if (!$results)
{
